...
b:;// darf ich vorstellen? mit wem red ich hier überhaupt... egal, das Hier ist b, es ist einfach nur b. wenn befohlen wird goto b; dann landet der compiler wieder hier.( wichtig für später
	...
	m:;
		...
		t:;
			...
			std::cout << "\n" << zahl1 << "+" <<zahl2 << "=" << zahl1+zahl2;											//hier werden die zwei zuvor eingegebenen Zahlen in allen arten 
			std::cout << zahl1 << "-" <<zahl2 << "=" << zahl1-zahl2;													//der mathematik (+,-,*,/) kombiniert. zahl1 ist immer am anfang!!!!
