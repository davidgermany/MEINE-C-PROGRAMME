// das ist ein kommentar. WILLKOMMEN IN DER STARK GEKÜRZTEN FASSUNG MEINES PROGRAMMS (92% kommentar-TEXT wurde gekürzt.) ja, es gibt noch ein deutlich längeres. hier ist alles mögliche drin was man halt mit zahlen machen kann.-David Matheja.
...

{
	...
	const long double pi = 3.14159265359;		//+const macht aus der variable eine Konstante. (eine FESTE ZAHL)
	 ...
	 a = 12; //a wird erstellt und gleich auf 12 gesetzt. INT variablen können nur ganze zahlen benutzen
	a += 3; //a wird 3 grösser (hier ist das = wichtig) das = hat die macht variablen zu ändern. es geht nur mit = !!!

	std::cout << "TEST 1049" << a << std::endl;  // Textausgabe. << std::endl ; macht ist ein zeilenumbruch (neue zeile)
	...
	std::cin.get();// wartet auf ENTER. 
												...
												//																				>_<
	std::cout << std::endl <<std::endl <<benutzer <<" gebe die präzisionsstärke ein (höher mehr präzision, kleiner schnellere berechnungen)  um das Programm zu starten, und etwas anderes um es zu beenden\n PS:normal sollte es 100 sein: ";
